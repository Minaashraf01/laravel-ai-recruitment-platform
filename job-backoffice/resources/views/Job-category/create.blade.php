<x-app-layout>
    ...
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg p-4 bg-white">
        <form action="{{ route('Job-category.store') }}" method="POST">
            ...
            <div>
                <button type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Create Category</button>
